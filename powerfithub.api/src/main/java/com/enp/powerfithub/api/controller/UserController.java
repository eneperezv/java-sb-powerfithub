...
/*
 * @(#)UserController.java 1.0 27/11/2024
 * 
...
import com.enp.powerfithub.api.model.ResponseDetails;
import com.enp.powerfithub.api.service.UserService;

@RestController
@RequestMapping("/api/v1/pfh/users")
